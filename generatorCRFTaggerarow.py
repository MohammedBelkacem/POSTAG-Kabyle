...
model = CRF(
    algorithm='arow', # Limited-memory  Broyden–Fletcher–Goldfarb–Shanno Algorithm.
...
print("Ismal yettemseḍfaṛen s waṭas:")
a=Counter(model.transition_features_).most_common(5)
for i in a:
    print(i)

##
print("\nIsmal urǧin ttemseḍfaṛen:")
b=Counter(model.transition_features_).most_common()[-5:]
for i in b:
    print(i)
...
##
##print("Top positive:")
a=Counter(model.state_features_).most_common(5)
for i in a :
    print (i)
##
##print("\nTop negative:")
